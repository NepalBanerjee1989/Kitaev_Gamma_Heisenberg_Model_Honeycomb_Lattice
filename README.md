...
Here, we use the parameter J1=0.1(FM), J2=0, J3=-0.2,K=1.0(FM), Gamma=0.4(FM), and that predicts a  zigzag AFM ground state for this material. We confirmed this with spin configuration and static spin-structure factor calculation.
...
We notice a micro-vortex state from real space spin configuration and confirmed that an exotic phase of matter using the static spin structure factor calculation, which clearly revealed the existence classical Z2 spin liquid.
