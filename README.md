...
We notice a micro-vortex state from real space spin configuration and confirmed that exotic phase of matter using the static spin structure factor calculation, which clearly revealed the existence of the classical Z2 spin liquid.
